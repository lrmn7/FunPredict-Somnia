...
export default function Footer() {
  const socialIcons = [
    { icon: TwitterIcon, href: "https://twitter.com/Somnia_Network", label: "Twitter" },
    { icon: DiscordIcon, href: "https://discord.gg/Somnia", label: "Discord" },
  ];

  return (
    <footer className="relative py-12 px-6 bg-background-lighter border-t border-white/10 overflow-hidden">
      <div className="absolute top-0 left-1/4 w-96 h-96 bg-accent/5 rounded-full blur-3xl pointer-events-none" />
      <div className="absolute bottom-0 right-1/4 w-96 h-96 bg-cyan/5 rounded-full blur-3xl pointer-events-none" />

      <div className="relative z-10 max-w-7xl mx-auto flex flex-col items-center justify-center gap-6">
        ...
        <div className="text-center">
          <p className="text-text-muted text-sm font-medium">
            &copy; {new Date().getFullYear()} FunPredict. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
